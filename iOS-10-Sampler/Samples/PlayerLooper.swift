...
class PlayerLooper: NSObject {
    ...
    struct ObserverContexts {
        internal static var isLooping = 0
        internal static var isLoopingKey = "isLooping"
        internal static var loopCount = 0
        internal static var loopCountKey = "loopCount"
        internal static var playerItemDurationKey = "duration"
    }
